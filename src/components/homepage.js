        ...
        <div className="home-page ">            
            <section className="col-md-12 upper-section man pan">
                <div className="col-md-12 man pan ">
                    <h1 className="spaced-out mtl ptl text-white mtsl ">Use daily meditation to improve your life!</h1>
                </div>
            ...
            <section className="col-md-12">
                ...
                <div className="info-columns">
                    <div className="col-lg-4 text-center  col-md-4 col-sm -12 left-info text-white">
                        <h4>Mental Benefits of Meditation</h4>
                    ...
                    <div className="col-lg-4 text-center  col-md-4 col-sm -12 left-info text-white">
                        <h4>Physical Benefits of Meditation</h4>
                    ...
                    <div className="col-lg-4 text-center  col-md-4 col-sm -12 left-info text-white">
                        <h4>Emotional Benefits of Meditation</h4>
                ...
                <div className="col-md-12 pal">
                    ...
                    <div className=" col-md-6 pam text-holder pal">
                        <p className="text-white text-center pal">Once you sign up, use the search function to find your favorite type of meditation music.  After that,
                ...
                <div className="col-md-12 pal">
                    <div className="col-md-6 pam text-holder pal">
                        <p className="text-white text-center pal">All session data is presented at the bottom of the dashboard.  It will display your Current Streak, Total Session,
